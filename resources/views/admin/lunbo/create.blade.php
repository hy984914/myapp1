...
@endif
	...
	<div class="portlet box blue">
		...
		<div class="portlet-body form">
			...
			<form action="/admin/lunbo" class="form-horizontal" method="post" enctype="multipart/form-data">
				<div class="control-group">

					<label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">轮播名</font></font></label>
