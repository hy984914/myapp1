            ...
            <div class="row-fluid">
                        ...
                        <div id="DataTables_Table_1_length" class="dataTables_length">
                            <label>
                                ...
                                <select size="1" name="num" aria-controls="DataTables_Table_1">
                                    ...
                                    <option value="20" @if($request->num == '10') selected="selected" @endif>
                                        10
                                    </option>
                                    <option value="30" @if($request->num == '15') selected="selected" @endif>
                                        15
                                    </option>
                ...
                <div class="span6">
                    <div class="dataTables_filter" id="sample_1_filter">
                        <label>
                            广告名:
                            <input type="text" name='poster_man' aria-controls="DataTables_Table_1" value="{{$request->poster_man}}">
                        </label>
                ...
                @foreach($rs as $k => $v)
                    ...
                    @endif
                        ...
                        <td class=" ">
                            ...
                            <a class='btn wine red' href="/admin/poster/{{$v->id}}/edit">修改</a>
